 ...
 */
void Artist::set_name(const std::string &n)
{
    name = n;
}
 ...
 * learned about 'The Big Five', and you don't need to understand these functions
 * to successfully implement the project, so we hid them down here.
 */
